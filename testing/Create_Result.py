...
from script_parameters import test_file, result_dir, final_result_file, model_number, PDNA_543_CT, PDNA_335_CT, average_result_dir
...
if __name__ == '__main__':
    ...
    create_combine_file(test_file, result_dir, final_result_file, model_number, float(threshold))
