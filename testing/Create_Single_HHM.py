...
def create_dir(workdir, sequence_file):
    ...
    os.system("rm -rf " + workdir + "/seq/")
    os.system("rm -rf " + workdir + "/a3m/")
    os.system("rm -rf " + workdir + "/hhr/")
    os.system("rm -rf " + workdir + "/hhm/")
    os.system("rm -rf " + workdir + "/msa/")
    os.system("rm -rf " + workdir + "/matrix/")
    os.system("rm -rf " + workdir + "/msa_deal/")
