...
from script_parameters import sub_feature_path1, sub_feature_path2, sub_feature_path3, test_file, model_dir, result_dir, feature_size1, feature_size2, feature_size3, feature_size4, label_size, model_number
...
class LSTM(object):
    ...
    def __init__(self, round_time, model_type):
        ...
        if(model_type == "PDNA-543"):
            self.current_model_dir = model_dir + "/PDNA_543/" + str(self.round_time) + "/"
        else:
            self.current_model_dir = model_dir + "/PDNA_335/" + str(self.round_time) + "/"
