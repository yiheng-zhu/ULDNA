...
cmd4 = "python " + script_file4 + " " + msa_path + "/msa/" + " " + sub_feature_path3
#os.system(cmd4)

script_file5 = code_path + "/Load_Model.py"
cmd5 = "python " + script_file5 + " " + model_type
os.system(cmd5)

script_file6 = code_path + "/Create_Result.py"
cmd6 = "python " + script_file6 + " " + test_file + " " + model_type + " " + threshold + " " + result_dir
os.system(cmd6)
